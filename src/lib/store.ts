...
export const usePortraitStore = create<PortraitStore>((set, get) => ({
  ...
  constraints: { lookAtCamera: false, bright: false, winking: false, naked: false, smiling: false, flirty: false, serious: false, lookingAway: false, dramatic: false, vintage: false },
