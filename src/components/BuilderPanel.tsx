          ...
          {BRIEFS.map((brief, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-lg border text-left transition-all cursor-pointer ${
                  active
              ...
              >
                ...
                <div className="flex items-center justify-between p-2.5">
                  <div className="flex-1 min-w-0 mr-2">
                    ...
                    <p className="text-[9px] text-[rgba(240,237,232,0.25)] truncate leading-tight mt-0.5" style={{ fontFamily: "'DM Mono', monospace" }}>
                      {brief.tagline}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.85 }}
                      className={`w-6 h-6 rounded-md border text-xs transition-all ${
                        active
                          ? "border-[#C8B99A]/50 text-[#C8B99A] hover:bg-[rgba(200,185,154,0.1)]"
                          : "border-white/10 text-[rgba(240,237,232,0.2)]"
                      }`}
                      style={{ fontFamily: "'DM Mono', monospace" }}
                    >−</motion.button>
                    <span
                      className={`w-5 text-center text-sm font-medium tabular-nums ${
                        active ? "text-[#F0EDE8]" : "text-[rgba(240,237,232,0.15)]"
                      }`}
                      style={{ fontFamily: "'DM Mono', monospace" }}
                    >{count}</span>
                    <motion.button
